...
from .similarity_functions import score_best_matches_with_index
...
class ModifiedCosineWithMatchedIndex(BaseSimilarity):
    ...
    score_datatype = [("score", np.float64), ("matches", "int"),
                      ("spec1_matched_indexes", "O"), ("spec2_matched_indexes", "O")]
    ...
    def pair(self, reference: SpectrumType, query: SpectrumType):
        ...
        -------
        Score
            Tuple with cosine score, number of matched peaks, matched peak indexes of reference and query.
        """
        ...
        score = score_best_matches_with_index(matching_pairs, spec1, spec2, self.mz_power, self.intensity_power)
