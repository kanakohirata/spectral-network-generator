...
if __name__ == '__main__':
    ...
    #     dset = h5_metadata['filtered/_metadata']
    #     h5_metadata.create_dataset('filtered/metadata', data=dset, shape=dset.shape, maxshape=(None,))
    #     del h5_metadata['filtered/_metadata']
    #     h5_metadata.flush()

    # with h5py.File('../spectrum_metadata.h5', 'a') as h5_metadata:
    #     dset = h5_metadata['filtered/metadata']
    #     arr = np.array(dset[()], dtype=[
    #         ('index', 'u8'), ('tag', H5PY_STR_TYPE), ('source_filename', H5PY_STR_TYPE),
    #         ('global_accession', H5PY_STR_TYPE), ('accession_number', H5PY_STR_TYPE),
    #         ('precursor_mz', 'f8'), ('rt_in_sec', 'f8'),
    #         ('retention_index', 'f8'), ('inchi', H5PY_STR_TYPE), ('inchikey', H5PY_STR_TYPE),
    ...
    #
    #     del h5_metadata['filtered/metadata']
    #     h5_metadata.create_dataset('filtered/metadata', data=arr, shape=arr.shape, maxshape=(None,))
    #
    #     dset = h5_metadata['metadata']
    #     arr = np.array(dset[()], dtype=[
    #         ('index', 'u8'), ('tag', H5PY_STR_TYPE), ('source_filename', H5PY_STR_TYPE),
    #         ('global_accession', H5PY_STR_TYPE), ('accession_number', H5PY_STR_TYPE),
    #         ('precursor_mz', 'f8'), ('rt_in_sec', 'f8'),
    ...
    #     ])
    #
    #     del h5_metadata['metadata']
    #     h5_metadata.create_dataset('metadata', data=arr, shape=arr.shape, maxshape=(None,))
