...
def write_edge_info(path, score_threshold, minimum_peak_match_to_output, mz_tolerance):
    with h5py.File('./spectrum_metadata.h5', 'r') as h5_meta:
        ...
        for arr, chunk_start, chunk_end in get_chunks('clustered_score', db_chunk_size=10000, path='./score.h5'):
            ...
            LOGGER.debug(6)
            df.rename(columns={
                'cluster_id_a': 'X_CLUSTERID', 'cluster_id_b': 'Y_CLUSTERID',
                'accession_number_a': 'REP_SPECTRUM_X_ACCESSION', 'accession_number_b': 'REP_SPECTRUM_Y_ACCESSION',
                'global_accession_a': 'REP_SPECTRUM_X_GLOBAL_ACCESSION', 'global_accession_b': 'REP_SPECTRUM_Y_GLOBAL_ACCESSION',
                'source_filename_a': 'SPECTRUM_X_FILENAME', 'source_filename_b': 'SPECTRUM_Y_FILENAME',
                'score': 'SCORE', 'matches': 'NUM_MATCHED_mz_list', 'delta_mz': 'DELTA_MZ',
                'precursor_mz_a': 'X_PRECURSOR_MZ', 'precursor_mz_b': 'Y_PRECURSOR_MZ',
                'rt_in_sec_a': 'X_PRECURSOR_RT', 'rt_in_sec_b': 'Y_PRECURSOR_RT',
                'title_a': 'X_TITLE', 'title_b': 'Y_TITLE', 'inchi_a': 'X_INCHI', 'inchi_b': 'Y_INCHI',
                'inchikey_a': 'X_INCHI_KEY', 'inchikey_b': 'Y_INCHI_KEY',
                'matched_mz_a': 'X_MATCHED_MZ', 'matched_mz_b': 'Y_MATCHED_MZ',
                'matched_peaks_a': 'X_MATCHED_mz_list', 'matched_peaks_b': 'Y_MATCHED_mz_list',
                'pathway_unique_id_list_a': '1', 'pathway_unique_id_list_b': '2',
                'pathway_common_name_list_a': '3', 'pathway_common_name_list_b': '4',
                'y_or_n_pathway_unique_id_matched': '5',
                'cmpd_classification_kingdom_list_a': '6', 'cmpd_classification_kingdom_list_b': '7',
                'y_or_n_cmpd_classification_kingdom_matched': '8',
                'cmpd_classification_superclass_list_a': '9', 'cmpd_classification_superclass_list_b': '10',
                'y_or_n_cmpd_classification_superclass_matched': '11',
                'cmpd_classification_class_list_a': '12', 'cmpd_classification_class_list_b': '13',
